...
//books array
 const int maxSize = 12; // define the maximum number of books
    ...
    int size= 8;   //size of the book array
...
const int maxOrders = 5; // define the maximum number of orders
   Order orders[maxOrders] = {
    {"2023/12/25","Gamunu College", "Famous Five", "Enid Blyton", 10, 2250},
    {"2023/12/26","ICBT Campus","C++ Beginner", "Dr.Roy", 2, 1800},
   };

   int orderSize=2;   //size of the order array
...
void addOrder(Order orders[], int& orderSize) {
